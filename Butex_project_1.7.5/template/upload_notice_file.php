...
//    echo "Size : " . ($_FILES["file"]["size"] / 1024) . " Kb<br />";
      ...
      if (file_exists("./template/uploaded_notice_files/" . $_FILES["file"]["name"]) || file_exists("./template/uploaded_notice_files/confidential/" . $_FILES['file']['name'])) {
        ...
        if ($_POST["notice_to_board"] == "yes") {
          ...
          $sql = "INSERT INTO `confidential_notice` (`notice_title`, `file_name`, `related_employees`, `date_of_publication`) VALUES('$title', '$file_name', '$related_employee', '$date_of_upload')";
          @mysql_query($sql);
        }
