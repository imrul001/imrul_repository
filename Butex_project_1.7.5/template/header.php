          ...
          $.ajax({
            ...
            success:function(data)
            {
              ...
              {   alert("email");
                ...
                $('#registration_error_msg1').html("<p style='text-align:center;'>The Email Addrss is already used.</p>");
                
              }
              else if(msg1 =='invalidEmail'){
                $('#response1').html("<img style='margin-top:2px;' src='./template/img/cross1.png' width='19px' height='19px'/>");
                $('#registration_error_box1').css("display", "block");
                $('#registration_error_msg1').html("<p style='text-align:center;'>Invalid Email Address</p>");
              }
            }
          });
          ...
          $.ajax({
            ...
            success:function(data){
              ...
              if(msg == 'ok'){
                ...
                alert("Failed...Can not change Passwor");
              }
              else{
                alert(data);
              }
