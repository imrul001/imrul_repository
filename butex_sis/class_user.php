...
//			$user_pass = md5($user_pass);
            ...
            $sql = "INSERT INTO `input` (`student_status`, `std_id`, `al_dept`, `mi_dept`, `s_ship`, `session`, `admission_test_roll_no`, `merit_position`, `dept`, `stud_name`, `gender`, `religion`, `father_name`, `mother_name`, `dob`, `p_address`, `c_address`, `stud_contact_no`, `grd_contact_no`, `nationality`, `emergency_contact_no`, `emergency_contact_address`, `blood_grp`, `ssc_board`, `ssc_academic_institute`, `ssc_year`, `ssc_roll`, `ssc_gpa`, `hsc_board`, `hsc_academic_institute`, `hsc_year`, `hsc_roll`, `hsc_gpa`, `grd_income`, `extra_curricular`, `link`, `reg_no`) VALUES('$studnet_status','$student_id', '$al_dept', '$mi_dept', '$s_ship', '$session', '$ad_roll', '$merit_position', '$dept', '$stud_name', '$gender', '$religion', '$father_name', '$mother_name', '$dob', '$p_address', '$c_address', '$stud_contact_no', '$grd_contact_no', '$nationality', '$emergency_contact_no', '$emergency_contact_address', '$blood_grp', '$ssc_board', '$ssc_ac', '$ssc_year', '$ssc_roll', '$ssc_gpa', '$hsc_board', '$hsc_ac', '$hsc_year', '$hsc_roll', '$hsc_gpa', '$grd_income', '$extraCurricular', '$image', '$reg_no')";
            if (!@mysql_query($sql)) {
                die(mysql_error());
            }
