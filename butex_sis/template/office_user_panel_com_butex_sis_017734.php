...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        //    javascript for registration form submit
        $('#registrationFormSubmitButton').live('click',function(){
            var student_id =$('#student_id').val().trim();
            $.msgBox({
                title: "Confirmation",
                content: "Verify the Student id "+student_id+".After submission it will not be editable.",
                type: "confirm",
