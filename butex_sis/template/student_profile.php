  ...
  <!--    <P>After that you will be able to login with the user id <strong><?php reg_info('student_id'); ?></strong>.</p>-->
    ...
    <div class="profileContainer" style=" ">
      ...
      <div class="basic_information">
        ...
        <div class="Container2">
          <p>Department of Allied Engineering</p>
          <p>0604001</p>
          <p>255</p>
          <p>101</p>
        </div>
      ...
      $result = mysql_query($sql);
      while ($row_norm = mysql_fetch_array($result)) {
      ...
      echo "<table class='student_list_table' style='margin: 0 auto;' border='1px solid black' cellpadding=4 cellspacing=5>
          <tr>
            <th class='table_header' style='padding-left: 0px; padding-bottom: 10px; text-decoration: underline'>Date Time</th>
            <th class='table_header' style='padding-left: 0px; padding-bottom: 10px; text-decoration: underline'>Student ID</th>
            <th class='table_header' style='padding-left: 0px; padding-bottom: 10px; text-decoration: underline'>Punishment</th>
            <th class='table_header' style='padding-left: 0px; padding-bottom: 10px; text-decoration: underline'>Warning</th>
          </tr>";

      while ($row = mysql_fetch_array($result)) {
        echo "<tr>";
        echo "<td class='table_data'>" . $row_norm['date_time'] . "</td>";
        echo "<td class='table_data'>" . $row_norm['std_id	'] . "</td>";
        echo "<td class='table_data'>" . $row_norm['punishment'] . "</td>";
        echo "<td class='table_data'>" . $row_norm['warning'] . "</td>";
        echo "</tr>";
      }
      echo "</table>";
       * 
