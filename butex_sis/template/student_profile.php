    ...
    <div class="profileContainer" style=" ">
      ...
      <div class="contact_info">
        ...
        <div class="basic imageContainer" style="float: right">
          <img width="170" src="./template/uploaded_student_images/<?php echo $m.".jpg"; ?>" />
        </div>
      </div>
      ...
      <div class="basic_information">
        <h2 class="h2header">Admission Information</h2>
        <div class="labels Container2">
          <p>Admission Roll No.:</p>
          <p>Merit Position:</p>
          <p>Registration No.:</p>
          <p>Alloted Department:</p>
          <p>Migrated Department:</p>
          <p>Scholarship:</p>
        </div>
        <div class="Container2">
          ...
          <p><?php echo $admission_roll; ?></p>
          <p><?php echo $al_dept; ?></p>
          <p><?php echo $mi_dept; ?></p>
          <p><?php echo $s_ship ?></p>
        </div>
      </div>
      <div class="basic_information">
        <h2 class="h2header">Emergency Information</h2>
        <div class="labels Container2">
        ...
        <div class="Container2">
          <p><?php echo $gard_contact_no; ?></p>
          <p><?php echo $emr_contact_no; ?></p>
          <p><?php echo $emr_contact_address; ?></p>
        </div>
      </div>
      ...
      <div class="basic_information">
        ...
        <div style="clear:both;">
          ...
          <div class="labels Container2">
            <p>SSC Board:</p>
            <p>Institution:</p>
            <p>SSC Information[Year-Roll-GPA]:</p>
          </div>
          <div class="Container2">
            <p><?php echo $ssc_board; ?></p>
            <p><?php echo $ssc_ac; ?></p>
            <p><?php echo $ssc_year . "-" . $ssc_roll . "-" . $ssc_gpa; ?></p>
          </div>
        </div>
        <div style="clear:both;">
          ...
          <div class="labels Container2">
            <p>HSC Board:</p>
            <p>Institution:</p>
            <p>HSC Information[Year-Roll-GPA]:</p>
          </div>
          <div class="Container2">
            <p><?php echo $hsc_board; ?></p>
            <p><?php echo $hsc_ac; ?></p>
            <p><?php echo $hsc_year . "-" . $hsc_roll . "-" . $hsc_gpa; ?></p>
          </div>
        </div>
      </div>
      <div class="basic_information">
      ...
      <div class="basic_information">
        ...
        <div style="clear:both;">
          ...
          <div class="labels Container2">
            ...
            <p>Back Log Course L2 T1</p>
            <p>Back Log Course L2 T2</p>
            <p>Back Log Course L3 T1</p>
            <p>Back Log Course L3 T2</p>
            <p>Back Log Course L4 T1</p>
            <p>Back Log Course L4 T2</p>
          </div>
          <div class="Container2">
            <p><?php echo $l1t1; ?></p>
            <p><?php echo $l1t2; ?></p>
