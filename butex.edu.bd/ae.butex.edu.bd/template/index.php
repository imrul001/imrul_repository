...
<div id="content">
  ...
  <div id="new_events_1">
    <div class="coda-slider"  id="slider-id_1">
      <div>
        <h3>BUTex Admission Announcement 2012-13</h3>
  ...
  <h2 class="title" style="margin-left: 10px;">News & Events</h2>
  <div id="new_events_2">
    <div class="coda-slider"  id="slider-id_2">
      <div>
        <h3>Here goes the heading</h3>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas metus nulla, commodo a sodales sed, dignissim pretium nunc. Nam et lacus neque. Sed volutpat ante id mauris laoreet vestibulum. Nam blandit felis non neque cursus aliquet. Morbi vel enim dignissim massa dignissim commodo vitae quis tellus. Nunc non mollis nulla. Sed consectetur elit id mi consectetur bibendum. Ut enim massa, sodales tempor convallis et, iaculis ac massa. Etiam suscipit nisl eget lorem pellentesque quis iaculis mi mattis. Aliquam sit amet purus lectus. Maecenas tempor ornare sollicitudin.</p>
      </div>
...
<!--        <div class="close"><a href="#" class="close" ><img class="close btn_close" width="25" height="27" src="./template/images/logo_transparent_back/crossButton2.jpg"/></a></div>-->
  ...
  <div id="buttons">
    <div class="modal_login_button button_div">
      <a style="text-decoration: none; font-weight: bold; color: #444; width: 20%;"  href="#login-box" class="login-window">Log In</a>
    </div>
    <div class="modal_login_button button_div">
      <a style="text-decoration: none; font-weight: bold; color: #444; width: 25%;"  href="#register-box" class="login-window">Register</a>
    </div>
    <div class="modal_login_button button_div">
